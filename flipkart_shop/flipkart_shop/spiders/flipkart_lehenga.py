...
class FlipkartSpider(scrapy.Spider):
    name = "flipkart_lehenga"
    allowed_domains = ["www.flipkart.com"]

    def start_requests(self):
        
        url = 'https://www.flipkart.com/search?q=women+lehenga'
    ...
    async def parse(self, response):
        ...
        next_pages = [f'https://www.flipkart.com/search?q=women+lehenga&page={i}' for i in range(2, 26)]
