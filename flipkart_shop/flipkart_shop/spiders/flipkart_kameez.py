...
class FlipkartSpider(scrapy.Spider):
    name = "flipkart_kameez"
    allowed_domains = ["www.flipkart.com"]

    def start_requests(self):
        
        url = 'https://www.flipkart.com/search?q=women+kameez'
    ...
    async def parse(self, response):
        ...
        next_pages = [f'https://www.flipkart.com/search?q=women+kameez&page={i}' for i in range(2, 26)]
